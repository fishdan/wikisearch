document.addEventListener('DOMContentLoaded', function() {
    // Finds all <a> tags containing 'linkmaker'
    const links = document.querySelectorAll('a[href*="linkmaker"]');
    ...
    links.forEach(link => {
        if (link.href.includes('github')) {
            ...
            span.id = 'linkmaker' + counter++; // Assigns incremented ID to each span
